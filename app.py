...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Anh Tú - Trường PTDTBT Tiểu học Yên Thuận - ĐT: 0342 871 092</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Anh Tú - Trường PTDTBT Tiểu học Yên Thuận - ĐT: 0342 871 092</div>", unsafe_allow_html=True)
